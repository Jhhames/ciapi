...
<!-- styles -->
	<link rel="stylesheet/less" type="text/css" href="<?= base_url('assets/themes/less/bootstrap.less') ?>" >
	<script src="<?= base_url('assets/themes/js/less/less.js') ?>" type="text/javascript"></script>
		...
		<span class="newTag tagRight"></span>
		  <ol class="carousel-indicators">
			...
			<div class="item active">
				<div class="row">
					<div class="span6">
						<img src="themes/images/carousel/carousel2.jpg" alt="#" />
					</div>
					<div class="span6">
			  ...
			  <div class="item">
				  <div class="row">
						<div class="span6">
							<img src="themes/images/carousel/carousel3.jpg" alt="#" />
						</div>
						<div class="span6">
							<div class="promoDetail">
			   ...
			   <div class="row">
			   <div class="span6">
					<img src="themes/images/carousel/carousel4.jpg" alt="#" />
				</div>
				<div class="span6">
					<div class="promoDetail">
...
<!--  javascript
    ...
    <script src="<?= base_url('assets/themes/js/jquery-1.8.3.min.js')?> "></script>
    <script src="<?= base_url('assets/bootstrap/js/bootstrap.min.js') ?>"></script>
    <script src="<?= base_url('assets/themes/js/smart.js')?>" ></script>
  </body>
</html>